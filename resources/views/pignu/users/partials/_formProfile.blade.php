    ...
    <div class="container-fluid">
            <div class="row">
                <div class="col-md-8 col-xs-12">
                    ...
                    <hr>
                    <div class="form-group row mb-4">
                        <label for="colFormLabelSm" class="col-sm-3 col-form-label col-form-label-sm text-right">Contraseña</label>
                        <div class="col-sm-8">
                            {{ Form::password('password', ['class' => 'form-control', 'placeholder' => 'Contraseña']) }}
                        </div>
                    </div>
                    <div class="form-group row mb-4">
                        <label for="colFormLabelSm" class="col-sm-3 col-form-label col-form-label-sm text-right">Confirmar contraseña</label>
                        <div class="col-sm-8">
